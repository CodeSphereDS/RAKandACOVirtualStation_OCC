...
namespace RAKandACOVirtualStation_OCC
{
	/// <summary>
	...
	public partial class App : Application
	{
		...
		protected override void OnStartup(StartupEventArgs e)
		{
			...
			ResourceDictionary rr = new ResourceDictionary();
			
			r.Source = new System.Uri("pack://application:,,,/FirstFloor.ModernUI;component/Assets/ModernUI.xaml");
			rr.Source = new System.Uri("pack://application:,,,/FirstFloor.ModernUI;component/Assets/ModernUI.Light.xaml");
			
			r.MergedDictionaries.Add(rr);

			StyleHelper.CreateStyleForwardersForDefaultStyles(r);
